            ...
            <CardContent>
                <Stack direction="row">
                    <Stack direction="column" flex={1} alignItems="flex-start">
                        <Typography sx={{ fontWeight: 600, fontSize: "16px", pb: 1 }}>
                            <FormattedDate
                                date={new Date(scheduledAt).toLocaleDateString()}
                            />
                        </Typography>

                        <Typography component="div" sx={{ fontWeight: 450, fontSize: "14px" }}>
                            {clientName}
                        </Typography>

                        <Box sx={{ display: "flex", width: "100%" }}>
                            <Typography sx={{ fontWeight: 300, fontSize: "13px", mr: 1, opacity: 0.8 }}>
                            ...
                            <Typography sx={{ fontWeight: 300, fontSize: "13px", opacity: 0.8 }}>
                                {eventLocation}
                            </Typography>
                        </Box>

                        <Typography component="div" sx={{ fontWeight: 300, fontSize: "13px", opacity: 0.8 }}>
                            {clientEmail}
                        </Typography>

                        <Typography component="div" sx={{ fontWeight: 300, fontSize: "13px", opacity: 0.8, pb: 1 }}>
                            {formatPhoneNumberIntl(clientPhone) || 'No phone'}
                        </Typography>
